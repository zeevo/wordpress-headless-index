...
if ( ! function_exists( 'headless_setup' ) ) :
	...
	function headless_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'headless_custom_background_args', array(
...
function headless_scripts() {
	wp_enqueue_style( 'headless-style', get_stylesheet_uri() );

	wp_enqueue_script( 'headless-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'headless-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
